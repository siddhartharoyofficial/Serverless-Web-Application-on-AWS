...
In this project, I have built a serverless web application using AWS Lambda, DynamoDB, and S3. The application will allow an individual to create, read, update, and delete (CRUD) items from a DynamoDB table.
